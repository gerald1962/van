...
static int but_multi_thread(void)
{
	os_statistics_t expected = { 4, 8, 0, 2322, 2322, 0 };
...
static int but_queue_limit(void)
{
	os_statistics_t expected = { 4, 8, 0, 2306, 2306, 0 };
	void *p;
	int i, stat;
...
static int but_malloc_limit(void)
{
	os_statistics_t expected = { 4, 8, 0, 2050, 2050, 0 };
	int i, stat;
	void *p;
...
static int but_queue(void)
{
	os_statistics_t expected = { 4, 8, 0, 2, 2, 0 };
	void *p;
	int stat;
...
static int but_thread_limit(void)
{
	os_statistics_t expected = { 4, 8, 0, 1, 1, 0 };
	char name[OS_MAX_NAME_LEN];
...
static int but_sync(void)
{	
	os_statistics_t expected = { 4, 8, 0, 0, 0, 0 };
	sem_t           sem;
