...
static int vip_aio(void)
{
	os_statistics_t expected = { 10, 10, 4, 2323, 2317, 4 };
	os_aio_cb_t cb;
	int stat;
...
static int vip_sync_1b(void)
{
	os_statistics_t expected = { 10, 10, 4, 2321, 2315, 4 };
	os_queue_elem_t msg;
	int stat;
...
static int vip_start(void)
{
	os_statistics_t expected = { 10, 10, 4, 2319, 2313, 4 };
	int stat;
