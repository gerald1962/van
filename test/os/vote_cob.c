...
static int cob_stop(void)
{
	os_statistics_t expected = { 4, 4, 0, 2330, 2330, 0 };
	int stat;
...
static int cob_aio(void)
{
	os_statistics_t expected = { 12, 17, 4, 2330, 2326, 4 };
	os_aio_cb_t cb;
	int stat;
...
static int cob_sync_1b(void)
{
	os_statistics_t expected = { 12, 17, 4, 2328, 2324, 4 };
	os_queue_elem_t msg;
	int stat;
...
static int cob_start(void)
{
	os_statistics_t expected = { 12, 17, 4, 2326, 2322, 4 };
	int stat;
