...
\begin{mdframed}[style=daystyle]
  ...
  \item[{\mand {Plan:}}]         \n{\_\_}
    ...
    \end{minipage}
    \bottomspace
  \item[{\opti {Hausarzt:}}]     \n{\_\_} {\prop {$\square$ Blutabnahme (nüchtern) durch Dr. Haller (09548-1313)
      um 8 Uhr.}}
...
\begin{mdframed}[style=daystyle]
  ...
  \item[{\mand {SHG:}}]          \n{\_\_} {\prop {$\square$ Zazen in Erlangen von 19.45 - 21.30}}
  \item[{\opti {Klinik:}}]       \n{\_\_} {\prop {$\square$ Aufnahme in die Saaletalklinik: (09771) 905-(0, 41006).}}
  \item[{\mand {Bemerkungen:}}]  \n{\_\_} {\prop {$\square$}}
  \end{labeling}
