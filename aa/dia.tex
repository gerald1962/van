...
\begin{mdframed}[style=daystyle]
  ...
  \item[{\mand {Plan:}}]         \n{\_\_}
    ...
    \begin{minipage}{0.75\textwidth}  
      ...
      \item[{\draf {$\square$ Plan:}}]     09.00 - 11.00
        
      \item[{\prop {$\square$ Wega:}}]     08.00 - 08.45
      \item[{\prop {$\square$ Mirel:}}]    09.00 - 09.45
      \item[{\prop {$\square$ Bias:}}]     10.00 - 10.45
      \item[{\prop {$\square$ Berwik:}}]   11.00 - 11.45        
      \item[{\prop {$\square$ Snoopy:}}]   11.30 - 12.00

      \item[{\prop {$\square$ Sport:}}]    12.30 - 17.00        
      \item[{\prop {$\square$ Snoopy:}}]   17.00 - 17.30
        
      \item[{\prop {$\square$ Kochen:}}]   17.30 - 19.30
      \item[{\prop {$\square$ Aufgaben:}}] 19.30 - 21.30
...
\begin{mdframed}[style=daystyle]
  ...
  \item[{\mand {Plan:}}]         \n{\_\_}
    ...
    \begin{minipage}{0.75\textwidth}  
      \begin{labeling}{\prop {$\square$ {Aufgaben:}}} 
        \setlength\itemsep{-3pt}
      \item[{\prop {$\square$ Plan:}}]     07.30 - 08.00
      \item[{\prop {$\square$ Wega:}}]     08.00 - 08.45
      \item[{\prop {$\square$ Mirel:}}]    09.00 - 09.45
      \item[{\prop {$\square$ Bias:}}]     10.00 - 10.45
      \item[{\prop {$\square$ Berwik:}}]   11.00 - 11.45        
