...
\begin{mdframed}[style=daystyle]
  ...
  \item[{\mand {Garten:}}]       \n{\_\_} {\prop {$\square$ Wiese}}
  \item[{\mand {Beruf:}}]        \n{\_\_} {\prop {$\square$ Diagnose-Lua, $\square$ Van-Rust}}
  \item[{\mand {SHG:}}]          \n{\_\_} {\prop {$\square$ Guttempler in Höchstadt von 19.00 - 20.00}}
  \item[{\opti {Hausarzt:}}]     \n{\_\_} {\prop {$\square$ Grosses Blutbild von Dr. Haller (09548-1313) für die Saaletalklinik.}}
  \item[{\opti {Klinik:}}]       \n{\_\_} {\prop {$\square$ Telefonat mit der Saaletalklinik: (09771) 905-0.}}
  \item[{\mand {Bemerkungen:}}]  \n{\_\_} {\prop {$\square$}}
  \end{labeling}
...
\begin{mdframed}[style=daystyle]
  ...
  \item[{\mand {Beruf:}}]        \n{\_\_} {\prop {$\square$ Diagnose-Lua, $\square$ Van-Rust}}
  \item[{\mand {SHG:}}]          \n{\_\_} {\prop {$\square$ Zazen in Erlangen von 19.45 - 21.30}}
  \item[{\opti {Klinik:}}]       \n{\_\_} {\prop {$\square$ Aufnahme in die Saaletalklinik: (09771) 905-0.}}
  \item[{\mand {Bemerkungen:}}]  \n{\_\_} {\prop {$\square$}}
  \end{labeling}
