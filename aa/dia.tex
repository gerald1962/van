...
\begin{mdframed}[style=daystyle]
  ...
  \item[{\mand {Backlog:}}]      \n{\_\_} {\prop {
    ...
    $+$ Zendo putzen, saugen; $+$ Gewürze auffüllen; $+$ Blumen entsorgen, $+$ Bücher sortieren,
    $+$ Tractatus, $+$ Band, $+$ Basis Bibel, $+$ Billy W.}}    
  \item[{\opti {Brennholz:}}]    \n{\_\_} {\prop {$\square$ Karli liefert in der KW 40 12 Ster Scheitholz.
    Liefertermin ist offen.}}
  \item[{\mand {Plan:}}]         \n{\_\_}
    \topspace
    \begin{minipage}{0.75\textwidth}  
...
\begin{mdframed}[style=daystyle]
  ...
  \item[{\mand {Sport:}}]        \n{\_\_}
    ...
    \begin{minipage}{0.75\textwidth}  
      ...
      \item[$\square$ Rumpfbeugen:]     {\prop {$s^0 \times e^{10}$ (3)}}
      \item[$\square$ Laufen:]          {\prop {$r^0 \times 3\ km$ (1)}}
      \item[$\square$ Liegestützen:]    {\prop {($r^{15} \land s^0 \times r^{10}) \vee (n=10, s^0 \times r^{n-1})$ (5-10), Ziel: 10}}
      \end{labeling}
    \end{minipage}
    \bottomspace        
  ...
  \item[{\mand {Backlog:}}]      \n{\_\_} {\prop {
    ...
    $+$ Zendo putzen, saugen; $+$ Gewürze auffüllen; $+$ Blumen entsorgen, $+$ Bücher sortieren,
    $+$ Tractatus, $+$ Band, $+$ Basis Bibel, $+$ Billy W.}}    
  \item[{\opti {Beratung:}}]     \n{\_\_} {\prop {$\square$ Treffen mit Frau Etter (09131 803-2330) in Erlangen um 15.30 Uhr.}}
  \item[{\mand {Plan:}}]         \n{\_\_}
    \topspace
    \begin{minipage}{0.75\textwidth}  
      \begin{labeling}{\prop {$\square$ {Aktion:}}} 
...
Bienioscheck, Horst: Duden Physik, 5. bis 10. Klasse \\
Börner, Heike: Mathematik, 5. Klasse \\
Herrmann, Bea: Geschichten erzählen, 4. Klasse \\
Herrmann, Bea: Sachtexte schreiben, 3. Klasse


\subsubsection{Naturwissenschaft}

Glaubrecht, Matthias: Charles Darwin
