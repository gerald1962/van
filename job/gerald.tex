...
\VollerName{Gerald Schüller}
\AbsenderStrasse{Stolzenroth 16A}
\AbsenderPLZOrt{96178 Pommersfelden}
...
\bwTelefon{Tel.:}{0176 43968956}       % optional
...
\bwEMail[Blue]{}{gerald.schueller@web.de}         % optional
...
\Firma{visit Soziale Dienste}
\Abteilung{Inhaber}            % optional
\AdressatVorname{Peter}              % optional
\AdressatNachname{König}                % ggf. optional
\AnschriftStrasse{Würzburger Str. 65}
\AnschriftPLZOrt{96049 Bamberg}
